...
import com.facens.AC2.Presentation.Controller.AdministradorController;
...
public class AdministradorControllerTest {
    ...
    public void testGetAllAdministradores() throws Exception {
        ...
        administradores.add(new ListAdministradorDto(1L, "Jo�o", "joao@gmail.com"));
    ...
    public void testCreateAdministrador() throws Exception {
        CreateAdministradorDto administrador = new CreateAdministradorDto(1, "João", "joao@gmail.com");
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/administrador/")
                ...
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.nome").value("Jo�o"))
